...
(function (IntersiteUtils) {
    ...
    function convertChapterViewerBySrcToIntersiteChapterViewer(chapterViewerBySrc, formattedNumber) {
        ...
        for (let src of Object.keys(chapterViewerBySrc)) {
    ...
    IntersiteUtils.convertChapterViewerBySrcToIntersiteChapterViewer = convertChapterViewerBySrcToIntersiteChapterViewer;
